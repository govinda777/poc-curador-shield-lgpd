...
export class AccessService {
     ...
     */
    static async wrapKeyForDoctor(patientWallet, recordId, doctorPublicKey, recordKey // The key used for AES-256-GCM
    ) {
        ...
        const wrappedKey = Buffer.from(crypto.publicEncrypt(doctorPublicKey, Buffer.from(recordKey))).toString('base64');
     ...
     * the decryption key.
     */
    static async revokeDoctorAccess(accessId) {
     ...
     */
    static async unwrapKey(wrappedKey, doctorPrivateKey) {
